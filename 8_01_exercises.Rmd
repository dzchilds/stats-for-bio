...
The figure below is an attempt to represent the following concepts: the sampling distribution, the standard error, the distribution of the sample, and the standard deviation.
...
How do the distributions of the three variables differ in terms of their central tendency, dispersion and skewness? Ask a TA to remind you what these refer to if you can't remember from last year.  
```
