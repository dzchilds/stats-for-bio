...
Let's step through the diagnostics for a one way ANOVA now, using the corn crake supplements example we used before. Read the data into R again and fit the model as before. 
