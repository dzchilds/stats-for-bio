...
We should not use a two-sample *t*-test when our data have this kind of strucure.

A paired-sample design can be very useful in biology because we often have the problem that there is a great deal of variation between the items we're studying (organisms, woodland sites, etc). In some cases, there may be so much among-item variation that the effect of any difference among the cases we're really intereted in is obscured.
