...
In the previous chapter we carried out *t*-tests to compare two means. The two samples we had in each case were entirely separate sets of measurements (purple and green plant morph dry weights). One measurement in one data set (e.g. the first green plant) has no link to any particular measurement in the second data set—-the measurements are said to be independent. The particular flavour of *t*-test you used in this situation is called a two-sample *t*-test (logically enough). 
