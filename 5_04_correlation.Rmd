...
-   The first part says that the test statistic associated with a Pearson's correlation coefficient is type of *t*-statistic. We're not going to spend time worrying about where this came from, other than to note that it is interpreted in exactly the same way as any other *t*-statistic. 
