...
<div id="box-text">
Use the `filter` function on the `storms` data set to select the rows containing just the observations associated with 'Hurricanes' that took place in 1997 or later. Print the result to the Console.
