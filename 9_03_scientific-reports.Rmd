...
Obviously it is important ensure the scientific name is spelled correctly. Fortunately systematists' scientific is fairly simple phonetically, but nonetheless it is best to check the name from a reliable source when writing it for the first time if you have only heard it spoken (try searching for `calopterix' on the web!). So now the spelling is right lets look at the parts of the name and how to present them. In typeset documents we usually see: 
