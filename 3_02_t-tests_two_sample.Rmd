...
In either case, a test with high degrees of freedom is more powerful than one with low degrees of freedom. That is, the higher the degrees of freedom, the more likely we are to detect an effect if it is present. This is why degrees of freedom matter.
```
