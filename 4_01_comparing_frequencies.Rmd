...
1. The $\chi^2$ distribution pops up a lot in statistics. However, in contrast to the normal distribution, it isn't often used to model the distribution of a variable we've sampled (i.e. 'data'). Instead, $\chi^2$ distribution is usually associated with a test statistic of some kind.
